...
const data = {
  ...
  engagement: [
    ...
    },
    {
      ...
      year: "Nov 2025",
      descCN: "参与第18届影展志愿服务工作，负责现场执行与观众接待，支持并参与酷儿文化公共空间的实践与运作。"
    },
    {
      id: 4,
...
### Chronos：被规训的线性时间
Chrono- 是代表时间的词根，它通常涉及：事件的顺序、持续的时长和测量的刻度。Chronos 来自希腊语 Khronos，是希腊神话中拟人化的时间，关于“我们如何量化地衡量岁月与生命”，代表线性的、可计量的流逝——钟表上的分钟、日历上的年月——过去、现在、未来这样连续不断的流逝。“All-devouring”（吞噬一切）和“inexorable”（不可阻挡）是他的核心标签。古希腊人认为，时间就像一条河流，会带走一切——青春、生命、记忆、王国。

资本主义继承并强化了 Chronos 的逻辑。在这套体系里，时间是一种资源，必须被有效利用；生命是一条轨道，必须按时前进——我们在既定的轨道读书、考研、就业、成家、积累，似乎每一步都有它应当发生的时刻，我们被困在线性的社会时间里，稍有停滞，便是落后；倒退或循环，则近乎失败。Chronos 是一种规训，它内化进我们对自身的批判，将我们拽进被时间之神吞噬的恐惧里——对“我还没有……”的焦虑，对间隔、休息、“今天什么都没做”的羞耻，都是 Chronos 的声音。

### Kairos：充盈的瞬间
与Chronos相对，希腊语还有另一个词：Kairos，指“确切或关键的时间”。Kairos是希腊希腊神话中的机遇之神。他双脚长有翅膀，四处奔走；但如果你足够留心，就能抓住他光秃后脑勺上垂着的那一绺长发。Kaiors不是均匀流逝的，而是“充盈的瞬间”——那些质感不同、无法被均分的时刻。正因为Kairos 是非均质的、有质地和密度的，它不能被计划，只能被遭遇。有些瞬间浓缩了无数时间，有些漫长的日子却几乎是空的。Kairos 的时间观抵抗“时间是容器”的隐喻，主张时间是事件本身，是那个当下的质地与密度——读到让自己震动的理论是 kairos，同伴之间某个无需言说的对视是 kairos，那些让我感到“爱让人变成透明的泡泡 心透明澄净 身体轻盈随意在空中飞动”的时刻是 kairos。这些瞬间或许发生在线性时间的缝隙里，它们无法被纳入人生主线的进度条，却是生命里最真实的部分。

### 酷儿时间：一种生存的伦理姿态
**Halberstam：脱轨的生命叙事**
Jack Halberstam 认为酷儿时间（queer time）是一种拒绝按照异性恋-资本主义规范排布生命的时序。异性恋规范的生命叙事以一组被赞颂的里程碑为标志——出生、童年、青春期、成年、婚姻、生育、为人父母、纪念日、退休与死亡——并要求人以"适当"的速度穿过每个阶段。许多人将这种“生育时间”内化为理所应当。但酷儿性可以是一种时间上的偏离——“奇异（queer）时间性、想象性的生活日程，以及偏心的经济实践”。当一个人的生命以这种方式展开，本身就构成对规范秩序的威胁。

**Freeman：时间规范性与时间生命政治**
Freeman 给了这套规训一个更精准的名字：“时间规范性”（chrononormativity）——即日程、日历、时区这些安排如何"看起来像是身体的事实"——我们以为朝九晚五是自然的，以为停滞是病态的，但这不过是历史上特定权力体制内化进身体的结果。当这种规训扩展到整个人口，就成了“时间生命政治”（chronobiopolitics）：国家通过出生登记、婚姻许可、死亡登记，定义什么叫“拥有一种生活”。没有登记栏位的生活——停滞的、绕路的、无产出的——在这套框架里根本不算存在。

### 解放时间
如果说 chronos 是规范，kairos 是裂缝，那么酷儿时间就是把裂缝扩展成一种生活方式的伦理选择。不是偶然地逃脱线性时间，而是有意识地拒绝它，并在拒绝中建立另一套评判生命价值的标准。酷儿性与不同步性相连，为与“时间规范性”、与“再生产的未来性”、与“再生产时间”、与“线性时间”，或与“美好生活”等规范性框架不同步。这种不同步，正是抵抗的形状。

对于我，对于大家，我想我们不要玩任何人的游戏，拒绝进入任何一套话语体系，拒绝成为任何一套宏大叙事的注脚。别把生活当作一场需要排练的演出，不要等待变厉害了才去生活。去碰撞，去遭遇，去让生命流经你——力量不是准备的结果，而是生活完美的结晶。我拒绝活在资本主义的线性时间里。去停滞，去倒退，去打结。允许自己愚蠢，允许自己毫无产出，允许自己仅仅是作为一个肉身存在，只是享受生命和一切不存在的意义。国家通过出生登记、婚姻许可、死亡登记来定义“拥有一种生活”的含义。但在那些表格的栏位之外，在那些无法被归档的时刻里——当我们无所事事，当我们只是单纯地呼吸与爱——这没有里程碑、没有“岸”、没有证书的日子，它正是时间生命政治视野之外的生活。它正是酷儿时间。

对于抵抗，对于瓦解，对于时间，不向虚无索要意义，不向未来预支当下，只在乎当下——唯有爱，以及我们身体切实的痛痒与温热——这无意义的物质性，才是唯一的永恒。

参考文献:
McCann, Hannah, and Whitney Monaghan. 2022. "Temporality and Queer Utopias." in Queer Theory Now: From Foundations to Futures. Reprinted by Bloomsbury Academic. London: Bloomsbury Academic.
Halberstam, Judith. 2005. "Queer Temporality and Postmodern Geographies." in In a Queer Time and Place: Transgender Bodies, Subcultural Lives, Sexual Cultures. New York: New York University Press.`
      }
    ]
  },
  cv: {
        ...
        <div key={r.id} style={{ padding: "1.5rem 0", borderBottom: theme.border, cursor: "pointer" }} onClick={() => setOpen(open === r.id ? null : r.id)}>
          ...
          {open === r.id && (
            <div style={{ marginTop: "1.2rem", animation: "fadeIn 0.3s ease" }}>
              ...
              {r.extra && (
                <div style={{ marginTop: "1rem", padding: "1rem", background: "rgba(0,0,0,0.02)" }}>
    ...
    <div style={{ minHeight: "100vh", fontFamily: theme.fontSans, color: theme.colorText, position: "relative" }}>
      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: 950, margin: "0 auto", padding: "0 1.5rem" }}>
        ...
        <main style={{ paddingBottom: "10rem" }}>
          {page !== "about" && (
             <h2 style={{ fontFamily: theme.fontSerif, fontSize: "2.5rem", fontWeight: 400, marginBottom: "3rem", textTransform: "capitalize" }}>{page === "engagement" ? "Public Engagement" : page}</h2>
          )}
          <div style={{ animation: "fadeIn 0.5s ease-out" }}>
               ...
               <div style={{ maxWidth: 850 }}>
                 {data.engagement.map(item => (
                   <div key={item.id} style={{ marginBottom: "2rem", borderBottom: theme.border, paddingBottom: "1.5rem" }}>
                     ...
                     <p style={{ fontSize: "1rem", lineHeight: 1.7, color: theme.colorSub }}>{item.descCN}</p>
            ...
            {page === "contact" && (
              <div style={{ maxWidth: 850 }}> {/* 宽度增加到850，让文字舒展 */}
