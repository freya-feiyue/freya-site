...
const data = {
  ...
  blog: {
    ...
    essays: [
      {
        id: 101,
        title: "Moments of Queerness: Sally Rooney and 'Normal People'",
        titleCN: "我获得酷儿性的一些时刻",
        date: "Dec 2025",
...
function FlagBackground() {
  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 0, overflow: "hidden", pointerEvents: "none", background: "#fff" }}>
      ...
      `}</style>
      <div style={{ position: "absolute", width: "160vw", height: "65vh", top: "-15%", left: "-10%", background: "linear-gradient(180deg, rgba(228,3,3,0.2) 0%, rgba(255,140,0,0.2) 16%, rgba(255,237,0,0.2) 33%, rgba(0,128,38,0.15) 50%, rgba(0,77,255,0.15) 66%, rgba(117,7,135,0.15) 83%, rgba(255,255,255,0) 100%)", filter: "blur(70px)", animation: "flow 25s infinite ease-in-out" }} />
      <div style={{ position: "absolute", width: "80vw", height: "100vh", right: "-10%", top: "0", background: "linear-gradient(180deg, rgba(255,244,48,0.22) 0%, rgba(255,255,255,0.4) 30%, rgba(156,89,209,0.22) 60%, rgba(30,30,30,0.1) 100%)", filter: "blur(80px)", animation: "flow 30s infinite ease-in-out reverse" }} />
